...
#В данной задаче есть система клиентов, каждый клиент может обслуживаться отдельно и есть возможность переключаться между клиентами. Обслужанный клиент выходит из очереди, а новый встаёт в неё.
