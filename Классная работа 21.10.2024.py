...
# Задача №6
#Рассчёт оценки по результатам теста
#Программа принимает количество правильных ответов на тесте и общее количество вопросов. Рассчитывает процент правильных ответов и выводит оценку - менеее 50% неудовлетворительно, от 50% до 70% удовлетворительно.
